...
const updatedByDays = 0; // If there is an update within 3 days, the issue is considered updated
const inactiveUpdatedByDays = -4; // If no update within 14 days, the issue is considered '2 weeks inactive'
const commentByDays = -2 // If there is an update within 14 days but no update within 7 days, the issue is considered outdated and the assignee needs 'To Update !' it
